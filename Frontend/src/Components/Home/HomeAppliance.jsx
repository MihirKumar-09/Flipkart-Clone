    ...
    const fetchAppliance = async () => {
      try {
        const res = await fetch(
          `${import.meta.env.VITE_BACKEND_URL}/api/products/section?category=Furniture,Tvs,Washing Machine,AirConditioners,Refrigerators,Mixer Grinders,Fans&limit=15&random=true`,
        );
